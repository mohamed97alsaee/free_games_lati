...
//
//     final pcGameModel = pcGameModelFromJson(jsonString);
...
class PcGameModel {
  ...
  factory PcGameModel.fromRawJson(String str) =>
      PcGameModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PcGameModel.fromJson(Map<String, dynamic> json) => PcGameModel(
        id: json["id"],
        title: json["title"],
