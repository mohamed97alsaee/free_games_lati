...
//
//     final webGameModel = webGameModelFromJson(jsonString);
...
class WebGameModel {
  ...
  factory WebGameModel.fromRawJson(String str) =>
      WebGameModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WebGameModel.fromJson(Map<String, dynamic> json) => WebGameModel(
        id: json["id"],
        title: json["title"],
